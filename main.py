...
root.title("Ankit Badhani URL shortener")
root.config(bg="#49A")
...
Label(root, text="Ankit Badhani URL shortener" , font="popins" ).pack(pady=10)
Entry(root,textvariable=url ,width=50).pack(pady=5 )
Button(root, text="Generate a short URL" ,command=urlshortener, ).pack(pady=7)
